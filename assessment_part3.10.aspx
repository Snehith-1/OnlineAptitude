<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.10.aspx.cs" Inherits="OnlineAptitude.asessment_part3__10" %>
...
<body>
    <asp:Image ID="img_top" runat="server" ImageUrl="~/images/vcidex_logo.gif" style="margin-left: 948px; margin-top: 0px;" Width="126px" ></asp:Image>
    ...
    <div class="row">
        ...
        <table class="auto-style1">
          <tr>
            ...
            <tr>
                <td>
                    <input type="radio" name="q11" value="A" /><label>A. 64</label><br />
                    <input type="radio" name="q11" value="B" /><label>B. 54</label><br />
                    <input type="radio" name="q11" value="C" /><label>C. 56</label><br />
                    <input type="radio" name="q11" value="D" /><label>D. 81</label>
                </td>
            </tr>
             </table>
