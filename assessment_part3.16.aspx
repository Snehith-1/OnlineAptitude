<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.16.aspx.cs" Inherits="OnlineAptitude.assessment_part3__16" %>
...
<body>
    ...
    <div class="row">
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td>
                    <input type="radio" name="q17" value="A" /><label>A. 4</label><br />
                    <input type="radio" name="q17" value="B" /><label>B. 16</label><br />
                    <input type="radio" name="q17" value="C" /><label>C. 8</label><br />
                    <input type="radio" name="q17" value="D" /><label>D. 1</label>
                </td>
            </tr>
             </table>
