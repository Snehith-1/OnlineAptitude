<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.20.aspx.cs" Inherits="OnlineAptitude.assessment_part3__20" %>
    ...
    <div class="row">
        ...
        <table class="auto-style1">
           <tr>
            ...
            <tr>
                <td>
                    <input type="radio" name="q21" value="A" /><label>A. 10 th</label><br />
                    <input type="radio" name="q21" value="B" /><label>B. 11 th</label><br />
                    <input type="radio" name="q21" value="C" /><label>C. 12 th</label><br />
                    <input type="radio" name="q21" value="D" /><label>D. 13 th</label>
                </td>
            </tr>
             </table>
