<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.3.aspx.cs" Inherits="OnlineAptitude.assessment_part3__3" %>
...
<body>
    ...
    <div class="row">
        ...
        <table class="auto-style1">    
            ...
            <tr>
                <td>
                    <input type="radio" name="q4" value="A" /><label>A. int length;</label><br />
                    <input type="radio" name="q4" value="B" /><label>B. char int;</label><br />
                    <input type="radio" name="q4" value="C" /><label>C. int long;</label><br />
                    <input type="radio" name="q4" value="D" /><label>D. float double;</label>
                </td>
            </tr>
             </table>
