<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.23.aspx.cs" Inherits="OnlineAptitude.assessment_part3__23" %>
...
<body>
    ...
    <div class="row">
        ...
        <table class="auto-style1">
         <tr>
            ...
            <tr>
                <td>
                    <input type="radio" name="q24" value="A" /><label>A. all attended to by</label><br />
                    <input type="radio" name="q24" value="B" /><label>B. attended by all</label><br />
                    <input type="radio" name="q24" value="C" /><label>C. fully attended to by</label><br />
                    <input type="radio" name="q24" value="D" /><label>D. like attending to all</label>
                </td>
            </tr>
             </table>
    ...
    <div  class="large-12 columns" style="text-align: center ;margin-left: -100px;">
        <p class="auto-style2" >
       <a href="assessment_part3.22.aspx" id="btnprevious" onclick="checkprevious();"   class="button radius" style="background-color:#003366;color:white;width:167px; height:40px;border:2px solid #b3b3b3;padding:10px;border-radius: 6px;margin-top: 15px; margin-left: 133px; border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;">PREVIOUS</a>
</p>
           <p class="auto-style3" >
       <a href="assessment_part3.24.aspx" id="btnnext" onclick="checknext();"   class="button radius" style="background-color:#003366;color:white;width:167px;margin-left: -100px; height:40px;border:2px solid #b3b3b3;padding:10px;border-radius: 6px;margin-top: 15px; margin-left: 133px; border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;">NEXT</a>
</p>
