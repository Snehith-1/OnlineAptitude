<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.22.aspx.cs" Inherits="OnlineAptitude.assessment_part3__22" %>
...
<body>
    <asp:Image ID="img_top" runat="server" ImageUrl="~/images/vcidex_logo.gif" style="margin-left: 1018px; margin-top: 0px;" Width="126px" ></asp:Image>
    ...
    <div class="row">
        ...
        <table class="auto-style1">
         <tr>
            ...
            <tr>
                <td>
                    <input type="radio" name="q23" value="A" /><label>A. Swallow : Edible</label><br />
                    <input type="radio" name="q23" value="B" /><label>B. Circumvent: Risky</label><br />
                    <input type="radio" name="q23" value="C" /><label>C. Accumulate : Insignmcant</label><br />
                    <input type="radio" name="q23" value="D" /><label>D. Control : Ungovernable</label>
                </td>
            </tr>
             </table>
