<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.12.aspx.cs" Inherits="OnlineAptitude.assessment_part3__12" %>
    ...
    <div class="row">
        ...
        <table class="auto-style1">
          <tr>
            ...
            <tr>
                <td>
                    <input type="radio" name="q13" value="A" /><label>A. Rs. 18.20</label><br />
                    <input type="radio" name="q13" value="B" /><label>B. Rs. 70</label><br />
                    <input type="radio" name="q13" value="C" /><label>C. Rs. 72</label><br />
                    <input type="radio" name="q13" value="D" /><label>D. Rs. 88.25</label>
                </td>
            </tr>
             </table>
