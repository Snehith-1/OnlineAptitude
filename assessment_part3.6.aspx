<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessment_part3.6.aspx.cs" Inherits="OnlineAptitude.asessment_part3__6" %>
    ...
    <div class="row">
        ...
        <table class="auto-style1">
           <tr>
            ...
            <tr>
                <td>
                    <input type="radio" name="q7" value="A" /><label>A. &lt;h6&gt;</label><br />
                    <input type="radio" name="q7" value="B" /><label>B. &lt;heading&gt;</label><br />
                    <input type="radio" name="q7" value="C" /><label>C. &lt;h1&gt;</label><br />
                    <input type="radio" name="q7" value="D" /><label>D. &lt;head&gt;</label>
                </td>
            </tr>
             </table>
